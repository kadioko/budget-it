...
export default function EditTransactionScreen() {
  ...
  return <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={nativeStyles.screen}><View style={nativeStyles.orbTop} /><View style={nativeStyles.orbBottom} /><ScrollView style={styles.scrollView} contentContainerStyle={[nativeStyles.content, styles.content]} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
  ...
  </ScrollView><View style={styles.stickyAction}><Pressable style={[nativeStyles.primaryButton, styles.saveButton, loading && styles.disabled]} disabled={loading} onPress={save}>{loading ? <ActivityIndicator color="#ffffff" /> : <Text style={nativeStyles.primaryButtonText}>Save changes</Text>}</Pressable></View></KeyboardAvoidingView>;
}
