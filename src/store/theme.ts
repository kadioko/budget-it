...
export const themeTokens = {
  light: {
    ...
    heroGradient: 'linear-gradient(135deg, rgba(219,234,254,0.96) 0%, rgba(240,249,255,0.94) 52%, rgba(255,255,255,0.98) 100%)',
    navSurface: 'rgba(255,255,255,0.76)',
  },
  dark: {
    background: '#081120',
    backgroundAccent: '#0f1b32',
    surface: 'rgba(11,23,42,0.82)',
    surfaceMuted: 'rgba(9,18,33,0.92)',
    ...
    heroGradient: 'linear-gradient(135deg, rgba(8,17,32,0.96) 0%, rgba(15,27,50,0.95) 52%, rgba(29,78,216,0.9) 100%)',
    navSurface: 'rgba(8,17,32,0.72)',
  },
} as const;
...
export const applyWebTheme = (mode: ThemeMode) => {
  ...
  root.style.setProperty('--app-font-body', '"Manrope", "Segoe UI", sans-serif');
  root.style.setProperty('--app-font-display', '"Space Grotesk", "Manrope", sans-serif');
